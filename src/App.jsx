...
function App() {
  ...
  return (
    ...
    <TopBar insertedQueryJson={setInsertedQueryJson} 
        ...
        setDBWindowOpen={setDBWindowOpen} DBWindowOpen={DBWindowOpen} setHeatMapData={setHeatMapData} setShowHeatMap={setShowHeatMap} setFlights={setFlights} setMarkerMapData={setMarkerMapData}  query_num={query_num} setQuery_num={setQuery_num} setQueriesDict={setQueriesDict} QueriesDict={queriesDict} setShowMarkerMap={setShowMarkerMap} allParams={allParams} params={displayParams} setParams={setDisplayParams}/>
