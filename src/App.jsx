...
function App() {
  ...
  return (
    ...
    <TopBar insertedQueryJson={setInsertedQueryJson} 
        ...
        setDBWindowOpen={setDBWindowOpen} DBWindowOpen={DBWindowOpen} setHeatMapData={setHeatMapData} setShowHeatMap={setShowHeatMap} setFlights={setFlights} setMarkerMapData={setMarkerMapData} setShowMarkerMap={setShowMarkerMap}/>
