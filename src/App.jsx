...
function App() {
  ...
  // list of lists in the format [lat, long, strngth]. this is the data for the heatmap
  const [queriesDict, setQueriesDict] = useState({
    "Marker Map": {},
    "Heat Map": {},
    Plane: {
      unique: {
        1: [new Date("2024-01-14T23:40:06"), new Date("2024-01-15T00:40:01")],
        2: [new Date("2024-01-17T09:07:51"), new Date("2024-01-17T09:25:44")],
      },
    },
  });
  ...
  }, [flights, position, mode, setMapData]);
  useEffect(() => {
    CalculateDateRange(flights, setDateRange);
  }, [flights]);
